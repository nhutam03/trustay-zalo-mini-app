export const hexToRgb = (hex, opacity = undefined) => {
...
export const cx = (...args: any[]) => args.filter((arg) => !!arg).join(" ");

import { setNavigationBarColor } from "zmp-sdk";
import { statusBarColor, textStatusBarColor } from "../constants/basic";
