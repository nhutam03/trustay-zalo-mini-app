...
export const createBookingRequest = async (
	...
	try {
		...
		throw new Error(extractErrorMessage(error, 'Không thể tạo yêu cầu đặt phòng'));
	}
};
...
export const getReceivedBookingRequests = async (params?: {
	...
	try {
		...
		const endpoint = `/api/room-bookings/received${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
		...
		throw new Error(extractErrorMessage(error, 'Không thể tải yêu cầu đặt phòng đã nhận'));
	}
};
...
export const getMyBookingRequests = async (params?: {
	...
	try {
		...
		const endpoint = `/api/room-bookings/my-requests${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
		...
		throw new Error(extractErrorMessage(error, 'Không thể tải yêu cầu đặt phòng của tôi'));
	}
};

// Get booking request by ID
export const getBookingRequestById = async (id: string): Promise<{ data: BookingRequest }> => {
	try {
		...
		throw new Error(extractErrorMessage(error, 'Không thể tải yêu cầu đặt phòng'));
	}
};
...
export const updateBookingRequestAsOwner = async (
	...
	try {
		...
		throw new Error(extractErrorMessage(error, 'Không thể cập nhật yêu cầu đặt phòng'));
	}
};
...
export const cancelMyBookingRequest = async (
	...
	try {
		...
		throw new Error(extractErrorMessage(error, 'Không thể hủy yêu cầu đặt phòng'));
	}
};
...
export const confirmBookingRequest = async (
	...
	try {
		...
		throw new Error(extractErrorMessage(error, 'Không thể xác nhận yêu cầu đặt phòng'));
	}
};
